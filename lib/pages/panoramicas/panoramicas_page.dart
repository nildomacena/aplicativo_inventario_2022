...
import 'package:aplicativo_inventario_2022/pages/panoramicas/widgets/view_image.dart';
          ...
          builder: (_) {
            return SizedBox(
              ...
              child: ListView(
                shrinkWrap: true,
                children: [
                  if (controller.localidade.panoramicas.isEmpty &&
                    ...
                    if (_.localidade.panoramicas.isNotEmpty) ...{
                      Container(
                          alignment: Alignment.center,
                          margin: const EdgeInsets.symmetric(
                              vertical: 20, horizontal: 10),
                          child: const Text('Imagens Salvas',
                              style: TextStyle(fontSize: 20))),
                      GridView.builder(
                        itemCount: _.localidade.panoramicas.length,
                        ...
                        itemBuilder: (context, index) {
                          return GestureDetector(
                            onTap: () {
                              Get.to(() => ViewImage(
                                  controller.localidade.panoramicas[index]));
                            },
                            child: Stack(
                              fit: StackFit.expand,
                              children: [
                    ...
                    Container(
                      ...
                      child: ElevatedButton.icon(
                          ...
                          label: Text(
                            _.salvando
                                ? 'Salvando...'
                                : _.localidade.panoramica.isNotEmpty &&
                                        _.imagem != null
